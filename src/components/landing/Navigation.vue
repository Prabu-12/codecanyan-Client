  ...
  <div>
    ...
    >
      <v-list>
        <v-list-item>
          <v-list-item-avatar>
            <img src="@/assets/img/landing/logo-quiz-2.png" alt="Logo" />
          </v-list-item-avatar>
          <v-list-item-content>
            <v-list-item-title class="title">Quiz</v-list-item-title>
            <v-list-item-subtitle>Plus</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    ...
    >
      <v-toolbar-title>
        <v-img src="@/assets/img/landing/logo-quiz-2.png" max-width="35px" />
      </v-toolbar-title>
      <v-spacer />
      <v-app-bar-nav-icon
        v-if="isXs"
