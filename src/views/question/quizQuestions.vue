                                        ...
                                        <v-row>
                                            ...
                                            >
                                                <v-text-field
                                                    ...
                                                    label="Question Video(youtube embed video)"                                                                                                    
                                                    clearable                       
                                                ></v-text-field>
                                            </v-col>
                                            <v-col
    ...
    methods:{
                ...
                if(file.name.includes('.csv')){
                    ...
                    .then(response=>{                
                        if(response.status==200){
                            var csvPath='\\'+response.data.dbPath
                            const obj={
                                path:csvPath,
        ...
        insertOrUpdateQuestion(){
            ...
            if(this.typeOptionSelect.questionTypeId==1&&this.quizObj.quizMarkOptionId!=2&&this.editedItem.correctOptionText==''){
                ...
                this.$root.$emit('message_from_parent_long','Only youtube embed video is allowed!please check the Question video.')
            }else{
