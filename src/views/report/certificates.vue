...
export default {
    ...
    methods:{
        ...
        editItem(item){
            //console.log(item)
            item.publishDate=item.publishDate==''?'':item.publishDate.substr(0,10)
            this.previewLeftImage=item.topLeftImagePath!=''?item.topLeftImagePath:''
            this.previewRightImage=item.topRightImagePath!=''?item.topRightImagePath:''
            this.previewBottomImage=item.bottomMiddleImagePath!=''?item.bottomMiddleImagePath:''
            this.previewBackGroundImage=item.backgroundImagePath!=''?item.backgroundImagePath:''
            this.previewSignatureLeft=item.leftSignatureImagePath!=''?item.leftSignatureImagePath:''
            this.previewSignatureRight=item.rightSignatureImagePath!=''?item.rightSignatureImagePath:''
