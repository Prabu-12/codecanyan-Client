<template>
    <v-container>
        ...
        <v-form ref="form">
            ...
            <v-row>
                <v-col cols="12" sm="4">
                    <v-checkbox label="Browser refresh end the exam" v-model="endExam"></v-checkbox>
                </v-col>
                <v-col cols="12" sm="4">
                    <v-checkbox label="Site logo on exam page" v-model="examPageLogo"></v-checkbox>
                </v-col>
            </v-row>
            <v-row>
            ...
            <v-row>
                <v-col cols="12" sm="4"><h3>Email Settings</h3></v-col>
            </v-row>
            <v-row>
                <v-col cols="12" sm="4">
                    <v-text-field label="Email" v-model="email" :rules="[rules.emailRules]"></v-text-field>
                </v-col>
                <v-col cols="12" sm="4">
                    <v-text-field label="Password" v-model="emailPassword" :type="'password'"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2">
                    <v-text-field label="Port" v-model="emailPort"></v-text-field>
                </v-col>
                <v-col cols="12" sm="2">
                    <v-text-field label="Host(SMTP)" v-model="emailHost"></v-text-field>
                </v-col>
            </v-row>
            <v-row>
